...
<template>
  <div>
    <div class="z-3">
      <select class="bg-black text-white my-4 mx-6" placeholder="selectionner une region" v-model="depSelect" @change="selection(depSelect)">
